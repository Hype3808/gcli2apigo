...
var Translations = map[Language]map[string]string{
	LanguageZH: {
		...
		"settings.password.help":                "用于登录管理面板的密码",
		"settings.api_key.help":                 "用于 API 请求认证的密钥（Bearer Token）| 如果未设置，将使用面板密码作为 API 认证",
		"settings.compatibility_mode.label":     "启用兼容性模式",
		"settings.compatibility_mode.help":      "启用后，所有 system 消息将转换为 user 消息，并停用 system_instructions",
	...
	LanguageEN: {
		...
		"settings.password.help":                "Password for logging into the admin panel",
		"settings.api_key.help":                 "API key for request authentication (Bearer Token). If not set, the panel password will be used for API authentication",
		"settings.compatibility_mode.label":           "Enable Compatibility Mode",
		"settings.compatibility_mode.help":            "When enabled, all system messages will be converted to user messages and system_instructions will be disabled. This can improve compatibility with certain models.",
